'''
在原始resnet18的基础上，改输入为4通道，并处理了一下预训练模型的加载
'''
...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        net.load_state_dict(torch.load(r'models/resnet18-5c106cde.pth'))
...
if __name__ == '__main__':
    pre_trained_model = resnet18(pretrained=True).cuda()
    summary(pre_trained_model, (4, 256, 256))
    print(list(pre_trained_model.children()))
